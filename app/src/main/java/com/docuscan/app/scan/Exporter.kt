...
object Exporter {
    ...
    fun run(context: Context, vm: DocViewModel, format: String): Result {
        ...
        val pageFormat = PageFormat.fromName(vm.settings.pageFormat, PageFormat.FIT_TO_IMAGE)
        val quality = PdfQualityPreset.fromName(vm.settings.pdfQuality, PdfQualityPreset.STANDARD)
